    ...
    func SetTileImage(){
        ...
        if !IsFruit() {
            ...
            case TileNode.FRUIT_BASKET_ID:
                sprite?.texture = SKTexture(image: #imageLiteral(resourceName: "FruitBasket"))
                break
            ...
            case 2:
                ...
                break
            case 3:
                sprite?.texture = SKTexture(image: #imageLiteral(resourceName: "mango2"))
                break
            case 4:
            ...
            case 5:
                ...
                break
            case 6:
                sprite?.texture = SKTexture(image: #imageLiteral(resourceName: "cherry2"))
                break
            default:
                sprite?.texture = SKTexture(image: #imageLiteral(resourceName: "Apple"))
                break
